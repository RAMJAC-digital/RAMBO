...
This file provides guidance to AI agents (including Claude Code, Cursor, and other AI-assisted development tools) when working with code in this repository.
