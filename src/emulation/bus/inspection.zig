...
//!
//! This module provides read-only memory inspection for debugging purposes.
//! Unlike busRead(), these functions do NOT trigger hardware side effects:
...
pub fn peekMemory(state: anytype, address: u16) u8 {
