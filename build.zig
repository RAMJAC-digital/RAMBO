...
pub fn build(b: *std.Build) void {
    ...
    // ControllerState unit tests (peripherals)
    const controller_state_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/emulation/state/peripherals/controller_state_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "RAMBO", .module = mod },
    ...
    controller_state_tests.root_module.addImport("xev", xev_dep.module("xev"));
